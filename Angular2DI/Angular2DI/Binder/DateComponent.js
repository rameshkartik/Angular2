...
var DateWidget_1 = require("../Service/DateWidget");
var DateComponent = (function () {
    function DateComponent(dateWidget) {
...
DateComponent = __decorate([
    core_1.Component({
        providers: [DateWidget_1.DateWidget],
        selector: 'date-ui',
        template: "Today Date: {{ dateToday }} <br/>"
    }),
    __metadata("design:paramtypes", [DateWidget_1.DateWidget])
], DateComponent);
